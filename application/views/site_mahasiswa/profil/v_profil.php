<div class="tabbable">
	...
	<div class="tab-content">
		<div class="tab-pane in active" id="profil">
			<?php $this->load->view('site_mahasiswa/profil/form_profil'); ?>
		</div>
		<div class="tab-pane" id="foto">
			<?php $this->load->view('site_mahasiswa/profil/form_foto'); ?>
		</div>
		<div class="tab-pane" id="password">
			<?php $this->load->view('site_mahasiswa/profil/form_pass'); ?>
		</div>
	</div>
