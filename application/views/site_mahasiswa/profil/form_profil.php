<script type="text/javascript">
  $(document).ready(function() {
    $('#simpan_profil_mhs').click(function() {
      /* Act on the event */
  ...
  <div class="span12">
    <form id="form-profil" name="form-profil">
      ...
      <div class="form-action center">
        <button type="button" name="simpan_profil_mhs" id="simpan_profil_mhs" class="btn btn-mini btn-primary"><i class="fa fa-save bigger-120"></i>Simpan</button>
      </div>
    </form>
  </div>
</div>
