...
if ($class=='home') {
  ...
  $grafik='';
    ...
    $gra_krs='';
    $gra_wisuda='';
}elseif ($class=='akademik_isinilai') {
  # code...
  $home='';
  $akademik='class="active open"';
    $akademik_isinilai='class="active"';
    $akademik_krs='';
    $akademik_mk='';
    $akademik_jadwal='';
    $akademik_khs='';
...
<ul class="nav nav-list">
  <li <?php echo $home; ?>>
    <a href="<?php echo site_url();?>site_dosen/home">
  ...
  <li <?php echo $akademik; ?>>
    ...
    <ul class="submenu">
      ...
      <li <?php echo $akademik_mk; ?>>
        <a href="<?php echo site_url('site_dosen/matakuliah');?>">
      ...
      <li <?php echo $akademik_jadwal; ?>>
        <a href="<?php echo site_url('site_dosen/jadwal');?>">
          <i class="menu-icon fa fa-caret-right"></i>
          Jadwal
        </a>
      ...
      <li <?php echo $akademik_isinilai; ?>>
        <a href="<?php echo site_url('site_dosen/isi_nilai');?>">
          <i class="menu-icon fa fa-caret-right"></i>
          Isi Nilai
        </a>
      ...
      <!-- <li <?php echo $akademik_krs; ?>>
        <a href="<?php echo site_url('site_dosen/krs');?>">
          <i class="menu-icon fa fa-caret-right"></i>
          Lihat KRS
        </a>
      ...
      <li <?php echo $akademik_khs; ?>>
        <a href="<?php echo site_url('site_dosen/khs');?>">
          <i class="menu-icon fa fa-caret-right"></i>
          Lihat KHS
        </a>
      ...
      <li <?php echo $akademik_ipk; ?>>
        <a href="<?php echo site_url('site_dosen/grafik_ipk');?>">
          <i class="menu-icon fa fa-caret-right"></i>
          Grafik IPK
        </a>
