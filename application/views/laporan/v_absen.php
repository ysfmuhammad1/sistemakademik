  ...
  <div class="widget-body">
    <div class="widget-main">
      <div class="control-group">
        <form class="form-horizontal" id="form" name="form" method="post" action="<?php echo site_url('lap_absensi/print_pdf')?>">
  ...
  $(document).ready(function() {
    ...
    function cari_mata_kuliah(){
      ...
      if(!$("#th_akademik").val() || !$("#kd_prodi").val()){
        ...
        $.ajax({
          type	: 'POST',
          url		: "<?php echo site_url('lap_absensi/cari_mata_kuliah'); ?>",
    ...
    //     $.ajax({
    //       type	: 'POST',
    //       url		: "<?php echo site_url('lap_absensi/print_pdf'); ?>",
    //       data	: string,
    //       cache	: false,
    //       success	: function(data){
    ...
    function cari_data(){
      ...
      if(!$("#th_akademik").val()){
        ...
        $.ajax({
          type	: 'POST',
          url		: "<?php echo site_url('lap_absensi/cari_data'); ?>",
          data	: string,
          cache	: false,
          success	: function(data){
            $("#view_detail").html(data);
