<div class="widget-box">
  <div class="widget-header">
      <h4 class="widget-title lighter-smaller"><i class="fa fa-print"> <?php echo "Cetak Data Mutasi"; ?></i></h4>
  </div>
  <div class="widget-body">
    <div class="widget-main">
      <div class="control-group">
        <form class="form-horizontal" id="form" name="form" method="post" action="<?php echo site_url('lap_mutasi/print_pdf')?>">
  ...
  $(document).ready(function() {
    ...
    function cari_data(){
      ...
      if(!$("#th_akademik").val()){
        ...
        $.ajax({
          type	: 'POST',
          url		: "<?php echo site_url('lap_mutasi/cari_data'); ?>",
          data	: string,
          cache	: false,
